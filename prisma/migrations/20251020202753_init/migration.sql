...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_supervisorsId_fkey" FOREIGN KEY ("supervisorsId") REFERENCES "Teacher"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
