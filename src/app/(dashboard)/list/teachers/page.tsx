...
const TeacherListPage = () => {
  const renderRow = (item: Teacher) => (
    ...
    >
      <td className="flex p-4 items-center gap-4">
        <Image
          src={item.photo}
          alt=""
          width={40}
        ...
        <div className="flex items-center gap-2">
          ...
          {role === "admin" && (
            <button className="w-7 h-7 flex items-center justify-center rounded-full bg-purple-200">
              <Image src={"/delete.png"} alt="" width={14} height={16} />
            </button>
          )}
        </div>
      </td>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt mt-0">
      {/* TOP */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {role==="admin" && <button className="w-8 h-8 flex items-center justify-center rounded-full bg-yellow-200">
